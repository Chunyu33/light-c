...
- "Support the author" redesigned: the reward codes now sit next to the message instead of above it, with a clearer note that all support goes into developing and maintaining the app.
